...
- Проект содержит генераторы для обработки массивов транзакций. Эти генераторы должны позволять финансовым аналитикам быстро и удобно находить нужную информацию о транзакциях и проводить анализ данных.
...
- В проект добавлена функция, которая обрабатывает данные о финансовых транзакциях, полученные из JSON-, CSV- или XLSX-файлов.
- Проект содержит функцию поиска операций по ключевым словам. Это позволит ускорить поиск информации по операциям.
- В проект добавлена функция, которая подсчитывает количество операций в каждой категории.
...
В модулях masks и utils реализована запись логов для отслеживания и устранения ошибок.
